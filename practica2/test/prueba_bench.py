...
# print(bestGenome, "\nfitness:", bestGenome.fitness)
#
# schwefel_1_2bounds = [(-100, 100)] * 10
# schwefel_1_2EA = EA(schwefel_1_2, schwefel_1_2bounds, 500)
# schwefel_1_2EA.run(1000000)
